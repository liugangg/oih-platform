...
app.include_router(adc.router,                 prefix="/api/v1/adc",          tags=["ADC Design"])
app.include_router(system.router,              prefix="/api/v1/system",       tags=["System Status"])
app.include_router(analysis.router,            prefix="/api/v1/analysis",     tags=["Analysis Tools"])
